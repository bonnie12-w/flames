        ...
        <div className="container mx-auto px-4 sm:px-6 flex items-center justify-between h-16">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[10px] text-muted-foreground tracking-wider uppercase">Amazonia Bistro</p>
            </div>
          </div>
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            <div className="glass-card rounded-2xl p-8 max-w-2xl">
              ...
              <div className="mt-6 p-4 rounded-xl bg-primary/10 border border-primary/20">
                <p className="text-xs text-primary">📧 Email summary sent to admin@AmazoniaBistro.co.ke</p>
              </div>
            </div>
          </motion.div>
        )}
